...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.UABlacklistCheck())
	{
	...
	geminiRouter.Use(middleware.UABlacklistCheck())
	{
	...
	geminiCompatibleRouter.Use(middleware.UABlacklistCheck())
	{
	...
	relayV1Router.Use(middleware.UABlacklistCheck())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.UABlacklistCheck(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.UABlacklistCheck())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.UABlacklistCheck(), middleware.Distribute())
	{
